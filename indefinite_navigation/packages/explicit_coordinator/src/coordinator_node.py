...
class VehicleCoordinator:
    ...
    def __init__(self):
        ...
        #self.pub_switch = rospy.Publisher("~switch", BoolStamped, queue_size=1) #Lidia
    ...
    def publish_topics(self):
        ...
        if self.clearance_to_go == CoordinationClearance.GO and not self.intersection_go_published:
            ...
            #self.pub_switch.publish(msg) ##LIDIA LINE
            #self.pub_intersection_done.publish(msg) ## LIDIA LINE #
            rospy.loginfo(f"Intersection go has been published!")
    ...
    def reconsider(self):
        ...
        #elif self.state == State.INTERSECTION_CONTROL:
        #    #self.set_state(State.LANE_FOLLOWING)
        #    self.pub_state.publish(FSMState(state="LANE_FOLLOWING"))
        ...
        print("This is the FSM state: " + str(self.mode))
