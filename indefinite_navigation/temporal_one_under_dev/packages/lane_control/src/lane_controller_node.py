...
class LaneControllerNode(DTROS):
    ...
    def getControlAction(self, pose_msg):
        ...
        #rospy.loginfo("This is the value of self.at_stop_line: " + str(self.at_stop_line))
        #rospy.loginfo("This is the value of self.at_obstacle_stop_line: " + str(self.at_obstacle_stop_line))
        #rospy.loginfo("This is self.mode: " + str(self.mode))
        #rospy.loginfo("This is the self.sub_state value: " + str(self.state))
        
        turn_type = self.turn_type

        if self.at_stop_line: #or self.at_obstacle_stop_line:
            rospy.loginfo("at_stop_line is true")
            v = 0
            omega = 0
            ...
            if turn_type == 0:
                ...
                self.forward_pose = True
                car_cmd_msg = Twist2DStamped(v=v, omega=omega)
