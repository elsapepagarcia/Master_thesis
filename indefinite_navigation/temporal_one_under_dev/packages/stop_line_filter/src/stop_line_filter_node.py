...
class StopLineFilterNode(DTROS):
    ...
    def cb_state_change(self, msg):
        #rospy.loginfo("The def cb_state_change is being accessed")
        #rospy.loginfo("This is the value of self.state: " + str(self.state))
        #rospy.loginfo("This is the value of msg.state: "+ str(msg.state))
    ...
    def cb_segments(self, segment_list_msg):
        ...
        if good_seg_count < self.min_segs.value:
            ...
            print("The value here in the else is: " + str(stop_line_reading_msg.at_stop_line))
